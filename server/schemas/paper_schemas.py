...
from core.models.schemas import PaperRequest, QuestionTypes
...
class PaperHistory(BaseModel):
    ...
    def to_response(self) -> 'PaperHistoryResponse':
        return PaperHistoryResponse(
            ...
            paper_pdf=f"/api/download/{self.thread_id}/paper.pdf",
            paper_docx=f"/api/download/{self.thread_id}/paper.docx",
            answer_pdf=f"/api/download/{self.thread_id}/answer.pdf",
